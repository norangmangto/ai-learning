...
def generate_images(
    ...
    # model_id="black-forest-labs/FLUX.1-dev",   # High quality version (20-50
    # steps)
    ...
    try:
        ...
        print(
            "3. Install: pip install diffusers transformers accelerate sentencepiece protobuf"
        )
    ...
    for idx, prompt in enumerate(prompts, 1):
        ...
        try:
            ...
            for img_idx, image in enumerate(images):
                filename = f"flux_{model_name}_{timestamp}_prompt{idx}_img{
    img_idx+1}.png"
    ...
    if not small_files:
        print(
            f"✓ All images have reasonable file sizes (Total: {
        total_size_mb:.2f} MB)"
        )
    else:
