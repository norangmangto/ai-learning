...
def visualize_segmentation(model, val_loader, device, num_samples=4):
    ...
    plt.savefig(output_dir / f'fcn_{CONFIG["model_variant"]}_results.png', dpi=150, bbox_inches='tight')
    print(f"\nSaved results to {output_dir / f'fcn_{CONFIG['model_variant']}_results.png'}")
