...
def generate_seq2seq_data(n_pairs=1000, src_len=20, tgt_len=25, src_vocab=100, tgt_vocab=80):
    """
    ...
    return np.array(src_sequences, dtype=np.int64), np.array(tgt_sequences, dtype=np.int64)
...
def main():
    ...
    src_seq, tgt_seq = generate_seq2seq_data(n_pairs=2000, src_len=20, tgt_len=25,
                                               src_vocab=100, tgt_vocab=80)
    ...
    val_src, val_tgt = src_seq[n_train:n_train+n_val], tgt_seq[n_train:n_train+n_val]
