...
import numpy as np
from sentence_transformers import SentenceTransformer, CrossEncoder, models, losses, InputExample
...
def main():
    ...
    dense_retriever = train_dense_retriever()
    
    # Train cross-encoder reranker
    cross_encoder = train_cross_encoder_reranker()
